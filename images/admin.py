...
class ImageAdmin(admin.ModelAdmin):
    list_display = ('title', 'image', 'uploaded_at', 'approved')
    list_filter = ('approved',)  # Filter images by approval status
    actions = ['approve_images', 'disapprove_images']  # Add custom actions
